...
export default function App(){
  ...
  // --- Home intelligence (fires only every 3 new searches, or on recovery, delayed 30s) ---
  useEffect(()=>{
    if(!user||searches.length<2||homeLoading||busy)return;
    ...
    if(!needsRefresh&&newSinceLastFeed<3)return;
    // Delay 30s to let any chat API call finish first
